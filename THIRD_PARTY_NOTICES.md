...
- **Noto Sans SC / TC / JP / KR and Source Han Sans** — Copyright 2014–2021 Adobe, Reserved Font Name `Source`. SIL OFL 1.1.
...
- **Inter** (`CJK Punct Bridge ?!` only) — Copyright 2016 The Inter Project Authors. `Inter UI` and `Inter` are trademarks of rsms. SIL OFL 1.1.
